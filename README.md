...
- Extensible for AI-assisted features

## Installation

1. Navigate to your Stable Diffusion WebUI extensions directory:
   ```bash
...
2. Clone this repository:
   ```bash
   git clone https://github.com/yourusername/sd-webui-smartphone-plus.git
   ```
...
1. Navigate to the **SP+** tab in the WebUI
2. Click the **InjectCSS** button to activate responsive mode
3. The button label will change to **ExtractCSS** when active
4. Click again to deactivate and return to normal mode
